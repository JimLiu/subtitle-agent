...
export type PreviewPanelStoreState = PreviewPanelStoreData &
  PreviewPanelStoreActions;

export type PreviewPanelStore = Mutate<
  StoreApi<PreviewPanelStoreState>,
 ...
 */
export function createPreviewPanelStore(
  initialState: Partial<PreviewPanelStoreData> = {}
): PreviewPanelStore {
  return createStore(
